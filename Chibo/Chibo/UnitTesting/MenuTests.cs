...
//        [TestMethod]
//        public void MenuMethodFillDays()
//        {
//            Menu menu = new Menu("test");
...
//            //Recipe recipeToAdd = new Recipe("roast potato", new string[] { "peel", "roast" }, new string[] { "dinner", "healthy" });
//            Ingredient Water = new Ingredient("water", "watery", 0, 0.0f);
//            Ingredient Potato = new Ingredient("potato", "apple of the earth", 0, 5.0f);
//            //recipeToAdd.Add(new Ingredient("potato", "apple of the earth", 0, 5.0f), 0.05f);
//            //recipeToAdd.Add(new Ingredient("water", "watery", 0, 0.0f), 1.0f);
//            recipeToAdd.Add(Potato, 0.05f);
//            recipeToAdd.Add(Water, 1.0f);
//            string[] preferenceTags = { "dinner", "pancakes", "lunch" };

//            dayToAdd.AddRecipe(recipeToAdd); //issue is here

//            recipeToAdd = new Recipe("tomato soup", new string[] { "boil", "simmer" }, new string[] { "dinner", "healthy" });
//            Ingredient Tomato = new Ingredient("tomato", "red and squishy", 0, 15.0f);

//            recipeToAdd.Add(Tomato, 0.025f);
//            recipeToAdd.Add(Water, 1.0f);

//            dayToAdd.AddRecipe(recipeToAdd); //issue is here. Need to add ingredients
